...
def settingData(name, city, state, priority, services, extraservice, specificReq, feedback):
    ...
    if (inp == "y"):
        ...
        userArray = [uniqueId, name, city, state, priority, services, extraservice,
                     specificReq, feedback]  # priority(int),services(int),extraService(int),specificReq(str)
...
def uniqueIdgeneration():
    x=open('DisasterRecords.cvs','a')
    do i = 1
    while i < 6:
      print(i)
      i += 1
      if i> uniqueIdgeneration:
          print("Your Unique ID Has Been Generated")
      else:
          print("Unable to generate your unique ID")
...
# -------------------------Feedback System Fucntion---------------------------

def feedback():
    print("This is a Feedback System For the Disaster Management System the you Have  Used")
    feedback=int(input('''Enter A number 
                1 = Excellent
                2 = Very Good
                3 = Good 
                4 = Average 
...
if a == 5:
    ...
    if f == 1:
        ...
        afterDisaster()
a= print(" Do you want to give a feedback? Y/N")
if a=="Y":
    feedback()
if a=="B":
    print("Thank you! We Were Glad that you liked our service")
    
settingData(name, city, state, priority, services, extraservice, specificReq, feedback )
gettingData()
feedback()
